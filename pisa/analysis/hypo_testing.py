...
class HypoTesting(Analysis):
    ...
    def write_config_summary(self, reset_params=True):
        ...
        summary['data_params_hash'] = [d.params.hash for d in self.data_maker]
        summary['data_params'] = [[str(p) for p in d.params] for d in self.data_maker]
        summary['data_pipelines'] = [self.summarize_dist_maker(d) for d in self.data_maker]
        ...
        summary['h0_params_hash'] = [d.params.hash for d in self.h0_maker]
        summary['h0_params'] = [[str(p) for p in d.params] for d in self.h0_maker]
        summary['h0_pipelines'] = [self.summarize_dist_maker(d) for d in self.h0_maker]
        ...
        summary['h1_params_hash'] = [d.params.hash for d in self.h1_maker]
        summary['h1_params'] = [[str(p) for p in d.params] for d in self.h1_maker]
        summary['h1_pipelines'] = [self.summarize_dist_maker(d) for d in self.h1_maker]
