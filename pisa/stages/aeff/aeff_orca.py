...
class aeff_orca(Stage):  # pylint: disable=invalid-name
    """
    ...
    def apply_function(self):
        ...
        he_norm = self.params.he_norm.m_as('dimensionless')

        for container in self.data:
            if "nc" in container.name:
                he_mask = container["true_energy"] > 100
            else:
                he_mask = container["true_energy"] > 500
            ...
            container['weights'][he_mask] *= he_norm
