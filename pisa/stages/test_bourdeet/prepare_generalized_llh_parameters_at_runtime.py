...
class prepare_generalized_llh_parameters_at_runtime(PiStage):
    """
    ...
    def __init__(self,
        ...
        # init base class
        super(prepare_generalized_llh_parameters_at_runtime, self).__init__(data=data,
                                       params=params,
    ...
    def apply_function(self):
        ...
        for container in self.data:
            ...
            assert container['weights'].get('host').shape[0]>0, 'ERROR: container %s is empty'%(container.name)
        ...
        for container in self.data:
            ...
            if sum(var_z<0)!=0:
                print('warning: var_z is less than zero')
            ...
            print(container.name, 'fucking alphas: ',alphas)
            print(container.name, 'fucking mc event count: ',container['n_mc_events'].get('host'))
