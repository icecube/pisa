...
* [python](http://www.python.org) — version 3.7.x required (github CI has numerical issues for `numba_osc.py` using python 3.6; numba 0.45, which is required for SmartArray does not allow python 3.8 or higher)
  * Anaconda: built in
